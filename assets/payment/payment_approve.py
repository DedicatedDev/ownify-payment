...
def approval_program():
    ...
    withdraw = Seq(
        [
            ...
            # Assert(Gt(ascii_to_int(Btoi(Txn.application_args[1])),Int(0))),
            # InnerTxnBuilder.Begin(),
            # InnerTxnBuilder.SetFields({
            #     TxnField.type_enum: TxnType.Payment,
            #     TxnField.amount: ascii_to_int(Btoi(Txn.application_args[1])),
    ...
    #admin = Btoi(Txn.application_args[1])
    ...
    program = Cond(
        ...
        #[Txn.application_args[0] == Bytes("getFee"), getFee],
